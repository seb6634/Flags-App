      ...
      <div className="hero-content text-center">
        <div className="max-w-md">
          ...
          <section className="py-3 flex flex-col gap-5">
            <p>
              Vous pouvez aussi lancer une partie pour tester vos connaissances
              sur les drapeaux.
            </p>
            ...
            <>
              <section className="py-3 flex flex-col gap-5">
                <p>
                  ...
                  supplémentaires comme la sauvegarde de vos scores. le
                  changement de Thème, la sauvegarde de vos pays preféres.
                </p>
                <NavLink to={"/login"}>
